...
class ProductEconomics(Base):
    ...
    active_discount_percentage = Column(Float, default=0.0)
    active_promotional_price = Column(Float, nullable=True)
...
class ExecutionLog(Base):
    ...
    product_id = Column(String(50), nullable=False)
    action_type = Column(String(100), default="PRICE_DISCOUNT")
